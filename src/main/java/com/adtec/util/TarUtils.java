...
public class TarUtils {
	...
	public static void main(String[] args) {
		try {
			archiveDirAll("C:\\test\\20180928_141550_861temp\\to\\" , "C:\\test\\20180928_141550_861temp\\to.tar");
		} catch (Exception e) {
			e.printStackTrace();
		}
	    ...
	    /**
	     * 归档 多个文件 (文件夹下的文件，不包含 当前源文件夹名)
	     * 
	     */
	    public static void archiveDirAll( String srcDirStr  , String  destStr 
	    		) throws Exception {
	    	TarArchiveOutputStream taos = null;
	    	try {
	    		taos = new TarArchiveOutputStream(
	    				new FileOutputStream(destStr));
