...
public class EstAutoTask {
    ...
    /**
     * 
     * @return is_start_exec 
     */
    public String getIsStartExec() {
        return isStartExec;
    }
     ...
     * @param isStartExec 
     */
    public void setIsStartExec(String isStartExec) {
        this.isStartExec = isStartExec == null ? null : isStartExec.trim();
    }
}